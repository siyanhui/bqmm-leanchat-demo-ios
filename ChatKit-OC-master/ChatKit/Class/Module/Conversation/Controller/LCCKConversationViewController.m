...
@interface LCCKConversationViewController () <LCCKChatBarDelegate, LCCKChatMessageCellDelegate, LCCKConversationViewModelDelegate, LCCKPhotoBrowserDelegate, MMEmotionCentreDelegate>
...
- (void)viewDidLoad {
    ...
    [MMGifManager defaultManager].selectedHandler = ^(MMGif * _Nullable gif) {
        if(weakSelf) {
            weakSelf.chatBar.textView.text = nil;
            [weakSelf didSendGifMessage:gif];
        }
    };
